...
$val="";
$val .="%".$_POST['val']."%";
$stmt = $pdo->prepare("SELECT DISTINCT id_product, product_name, price FROM products WHERE product_name LIKE :product_name");
$stmt -> bindValue(':product_name', $val, PDO::PARAM_STR);
$stmt->execute();
